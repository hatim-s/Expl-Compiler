...
%type <node> StmtList Stmt InStmt OutStmt AssgnStmt InitStmt FreeStmt DeleteStmt
...
InStmt          : READ '(' Identifier ')' ENDSTMT   { $3->datatype = getVariableType ($3->varname); $$ = makeReadNode ($3); }; 
...
Identifier  : ID                    { $1->datatype = getVariableType ($1->varname); $$ = $1; } 
